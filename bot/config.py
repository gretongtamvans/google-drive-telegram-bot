...
class Messages:
    ...
    COPIED_SUCCESSFULLY = "📀🕶️ **Copied successfully.**\n[{}]({}) __({})__"
    ...
    AUTH_TEXT = "🖇️🖇️ **To Authorize your Google Drive account visit this [URL]({}) and send the generated code here.**\n__Visit the URL > Allow permissions > you will get a code > copy it > Send it here__"
